...
import "./OBDadminregistraion.css"
import { FaEye, FaEyeSlash } from 'react-icons/fa';

function OBDadminregistraion() {
    ...
    const registerAdmin = async () => {
        ...
        if (data._id != null) {
            setMessage("Admin Registration Successfull")
            alert("Admin Registration Successfull")
            window.location.href = "/"
        }
        else {
            setMessage("Admin Registraion Failed")
            alert("Admin Registraion Failed")
            window.location.href = "/"
    ...
    return (
        <>
            ...
            <table className="tabledonorregistrationadmin">

                <tr>
                    <th className="tableheadregistration">Admin Registration</th>
                </tr>
                <br></br>
                <tr>
                ...
                <tr >
                    <td className="registrationSwitch"><input className="registrationSwitchin" type="Submit" value="Save" onClick={registerAdmin} /></td>
                </tr>
                <br></br>
...
export default OBDadminregistraion