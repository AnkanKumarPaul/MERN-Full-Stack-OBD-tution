...
function OBDadminlogin() {
    ...
    const loginAdmin = async () => {
        ...
        if (data.message === true) {
            ...
            setMessage("Admin Login Successfull")
            alert("Admin login successfull, please wait...")
            ...
            window.location.href = "/"
            alert("Admin Login failed, check mail or password and try again")
    ...
    return (
        <>
            ...
            <table className="tableloginadmin">
                <tr>

                    <th className="tableheadlogin ">Admin Page</th>
                ...
                <tr >
                    <td className="registrationSwitchlogin" ><input onClick={loginAdmin} className="submit registrationSwitchin" type="Submit" value="Login" /></td>
                </tr>
                <tr>
                    <td>{message}</td>
                </tr>
                ...
                <tr>
                    <td>
                        New User? <Link to="/OBDadminregistraion" className="anchor anchorregister adminregisterlogin">Register here</Link>
                    </td>
                </tr>
                <br></br>
                <tr>
                    <td>
                        Forget Password? <Link to="/OBDUserforgetpassword" className="anchor anchorforget adminregisterforget">Click here</Link>
