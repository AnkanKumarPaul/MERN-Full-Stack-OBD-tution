...
import {faDroplet, faHandHoldingMedical, faHome, faEnvelope, faPhone, faCircleDollarToSlot } from '@fortawesome/free-solid-svg-icons'
                ...
                <div class="footer">
                    <div class="footer-first">
                        ...
                        <h3>
                            ...
                            {/* <b> Blood Donation</b> */}
                            <b> Donate Blood
                                <br></br> Save Lifes <FontAwesomeIcon className="blooddropiconfooter" icon={faDroplet} />   <FontAwesomeIcon icon={faHandHoldingMedical} className="doctoricon" />  </b>
                        </h3>
                    ...
                    <div class="footer-fourth">
                        ...
                        <ul>
                            ...
                            <li > <Link to="mailto:ankanpaul7897@gmail.com?subject = Feedback&body = Message" className="footeremail"> <FontAwesomeIcon icon={faEnvelope} /> Email </Link> </li> <br></br>
